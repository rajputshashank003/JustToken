...
function Footer() {
    return (
        <footer className="max-sm:w-[86vw] w-[42rem] rounded-md shadow m-4 mt-0 bg-slate-900">
            <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
            <span className="text-sm  sm:text-center text-gray-400">© {new Date(Date.now()).getFullYear()} <a href="https://chessv.netlify.app/" className="hover:underline">ChessV</a> All Rights Reserved &nbsp;
            </span>
